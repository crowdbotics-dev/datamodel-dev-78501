"""
Django settings for datamodel_dev_78501 project.
...
ROOT_URLCONF = 'datamodel_dev_78501.urls'
...
WSGI_APPLICATION = 'datamodel_dev_78501.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "datamodel_dev_78501 API",
    "DESCRIPTION": "API documentation for datamodel_dev_78501 App",
    "VERSION": "v1",
}
